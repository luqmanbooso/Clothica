...
const Checkout = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post(`/api/orders/create/${userId}`, null, {
        params: {
      ...
      const successOrderData = {
        ...
        discount: order?.discountAmount !== undefined ? order.discountAmount : discountAmount,
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-[#D4AF37]/30 focus:border-[#6C7A59] transition-all duration-300 text-[#1E1E1E] placeholder-[#9CAF88] font-medium ${errors.firstName
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-[#D4AF37]/30 focus:border-[#6C7A59] transition-all duration-300 text-[#1E1E1E] placeholder-[#9CAF88] font-medium ${errors.lastName
                        ? 'border-[#B35D5D] bg-[#F5F1E8] ring-[#B35D5D]/20'
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-[#D4AF37]/30 focus:border-[#6C7A59] transition-all duration-300 text-[#1E1E1E] placeholder-[#9CAF88] font-medium ${errors.email
                        ? 'border-[#B35D5D] bg-[#F5F1E8] ring-[#B35D5D]/20'
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-[#D4AF37]/30 focus:border-[#6C7A59] transition-all duration-300 text-[#1E1E1E] placeholder-[#9CAF88] font-medium ${errors.phone
                        ? 'border-[#B35D5D] bg-[#F5F1E8] ring-[#B35D5D]/20'
                ...
                <div className="md:col-span-2 group">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-[#D4AF37]/30 focus:border-[#6C7A59] transition-all duration-300 text-[#1E1E1E] placeholder-[#9CAF88] font-medium ${errors.address
                        ? 'border-[#B35D5D] bg-[#F5F1E8] ring-[#B35D5D]/20'
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className={`w-full px-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-[#D4AF37]/30 focus:border-[#6C7A59] transition-all duration-300 text-[#1E1E1E] bg-white/80 font-medium ${errors.province
                        ? 'border-[#B35D5D] bg-[#F5F1E8] ring-[#B35D5D]/20'
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className={`w-full px-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-[#D4AF37]/30 focus:border-[#6C7A59] transition-all duration-300 text-[#1E1E1E] bg-white/80 font-medium ${errors.city
                        ? 'border-[#B35D5D] bg-[#F5F1E8] ring-[#B35D5D]/20'
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-[#D4AF37]/30 focus:border-[#6C7A59] transition-all duration-300 text-[#1E1E1E] placeholder-[#9CAF88] font-medium ${errors.postalCode
                        ? 'border-[#B35D5D] bg-[#F5F1E8] ring-[#B35D5D]/20'
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-[#059669]/20 hover:shadow-xl transition-all duration-500 transform hover:scale-[1.02] animate-fade-in-up relative overflow-hidden" style={{ animationDelay: '0.1s' }}>
              ...
              <div className="space-y-4">
                {shippingMethods.map((method, index) => (
                  <label
                    key={method.id}
                    className={`flex items-center p-6 border-2 rounded-2xl cursor-pointer transition-all duration-300 transform hover:scale-[1.02] ${shippingMethod === method.id
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between w-full">
                      <div className="flex items-center">
                        <div className={`w-6 h-6 border-2 rounded-full mr-4 transition-all duration-300 ${shippingMethod === method.id
                      ...
                      <div className="text-right">
                        <p className={`font-bold text-2xl ${method.price === 0 ? 'text-[#9CAF88]' : 'text-[#1E1E1E]'
                          }`}>
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-[#B35D5D]/20 hover:shadow-xl transition-all duration-500 transform hover:scale-[1.02] animate-fade-in-up relative overflow-hidden" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                {paymentMethods.map((method, index) => (
                  <label
                    key={method.id}
                    className={`relative flex items-center p-6 border-2 rounded-2xl cursor-pointer transition-all duration-300 transform hover:scale-[1.02] ${paymentMethod === method.id
                      ? 'border-[#6C7A59] bg-gradient-to-r from-[#F5F1E8] to-[#E6E6FA] shadow-lg'
                  ...
                  >
                    ...
                    <div className="flex items-center w-full">
                      <div className={`w-6 h-6 border-2 rounded-full mr-4 transition-all duration-300 ${paymentMethod === method.id
                        ? 'border-[#6C7A59] bg-[#6C7A59] scale-110'
                        : 'border-[#D6BFAF]'
                        }`}>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full px-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-[#D4AF37]/30 focus:border-[#6C7A59] transition-all duration-300 text-[#1E1E1E] placeholder-[#9CAF88] font-medium ${errors.cardholderName
                            ? 'border-[#B35D5D] bg-[#F5F1E8] ring-[#B35D5D]/20'
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full px-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-[#D4AF37]/30 focus:border-[#6C7A59] transition-all duration-300 text-[#1E1E1E] placeholder-[#9CAF88] font-medium ${errors.cardNumber
                            ? 'border-[#B35D5D] bg-[#F5F1E8] ring-[#B35D5D]/20'
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full px-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-[#D4AF37]/30 focus:border-[#6C7A59] transition-all duration-300 text-[#1E1E1E] placeholder-[#9CAF88] font-medium ${errors.expiryDate
                            ? 'border-[#B35D5D] bg-[#F5F1E8] ring-[#B35D5D]/20'
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full px-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-[#D4AF37]/30 focus:border-[#6C7A59] transition-all duration-300 text-[#1E1E1E] placeholder-[#9CAF88] font-medium ${errors.cvv
                            ? 'border-[#B35D5D] bg-[#F5F1E8] ring-[#B35D5D]/20'
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-[#7C3AED]/20 sticky top-8 hover:shadow-xl transition-all duration-500 transform hover:scale-[1.02] animate-fade-in-up relative overflow-hidden" style={{ animationDelay: '0.3s' }}>
              ...
              <div className="border-t-2 border-[#D4AF37] pt-6 space-y-4 bg-gradient-to-r from-[#F5F1E8] to-[#E6E6FA] rounded-2xl p-6 border border-[#D4AF37]/20">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className={`font-semibold text-lg ${shippingCost === 0 ? 'text-[#9CAF88]' : 'text-[#1E1E1E]'
                    }`}>
                    {shippingCost === 0 ? 'FREE' : `LKR ${shippingCost.toLocaleString()}`}
                  </span>
                </div>
                {discountAmount > 0 && (
                  <div className="flex justify-between items-center text-[#B35D5D]">
                    <span className="font-medium">Discount ({appliedCoupon.code})</span>
                    <span className="font-semibold text-lg">- LKR {discountAmount.toLocaleString()}</span>
                  </div>
                )}
              ...
              <button
                ...
                className={`w-full mt-8 py-6 px-8 rounded-2xl font-bold text-white transition-all duration-500 transform hover:scale-105 shadow-2xl hover:shadow-xl ${isProcessing || !(Object.keys(formData).every(key => formData[key]?.trim()) && shippingMethod && paymentMethod)
